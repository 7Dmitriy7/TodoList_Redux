...
interface formProps {
  title: string;
  regSubmit: (email: string, password: string) => void;
  // logButton?: () => void;
  // regButton?: ()  => void;
}
        ...
        <form
          ...
          <Wrapper>
            ...
            <Stack sx={{ display: 'flex', justifyContent: 'center', }} direction="column" spacing={1}>
                ...
                {/*<Button  size="large" sx={{ borderRadius: '10px' }} variant="outlined">*/}
                {/*  Войти*/}
                {/*</Button>*/}

                <Button type='submit'size="large" sx={{ borderRadius: '10px' }} variant="outlined" color="success" disableElevation>
                  СОЗДАТЬ АККАУНТ
                </Button>
            </Stack>
          </Wrapper>
